 ...
 * Sk�adaj� si� z dw�ch p�l, zmiennej informuj�cej o ilo�ci wczytywanych liczb oraz z tablicy, 
 * w kt�rej s� one przechowywane. 
 *                      
 * 
 */ 
class Liczby { 
	...
	/*!
	 * Pole przechowuje informacj� o ilo�ci wczytanych liczb
	 */ 
	int ilosc;
	/*!
	 * Tablica zawiera wczytane liczby z pliku .txt
	 * Dyrektywa przeprocesora ROZMIAR, ogranicza maksymaln� ilo�� wczytanych liczb.
	 * Jej warto�� mo�na zmienia�, w zale�no�ci od potrzeb. 
	 */ 
	int * tablica;
...
/*!
*\return Zwraca warto�� pola rozmiar klasy Liczby.
* 
*/ 
int IloscLiczb() { return ilosc; }
	
/*!
 * Modyfikuje warto�� pola rozmiar w klasie Liczby. 
 *
 */  	
...
/*!
 * Metoda przypisuje warto�� odpowiedniemu elementowi tablicy tab_liczb.
...
/*!
 *\brief  Wy�wietlanie liczb 
 * 
 * Zadaniem funkcji jest wy�wietlenie liczb na wyj�cie. S� zapisane w obiekcie klasy Liczby,
 * kt�ry jest parametrem jej wywo�ania.
 * 
 */ 
int WyswietlLiczby();
...
/*!
 *\brief Sprawdzenie wynik�w mno�enia 
 * 
 * Uzyskane wyniki, s� por�wnywane z liczbami zawartymi w drugim pliku .txt.
 * Odpowiadaj� one poprawnym wynikom. Funkcja sprawdza czy wszystko si� zgadza, informuj�c  
 * o rezultacie u�ytkownika poprzez komunikat na wyj�ciu.
 *
 ...
 * 
 * Funkcja wczytuje liczby z pliku .txt. Wykorzystywana zar�wno przy wczytywaniu liczb do przemo�enia
...
int Liczby::SprawdzWyniki(Liczby & wyniki){
	...
	if(this->IloscLiczb()!=wyniki.IloscLiczb()){
		 cout<<" Rozmiary wczytanych plik�w s� r�ne !" <<endl;
		 return -1;
	}
